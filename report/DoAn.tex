...
\usepackage{longtable} % Bảng dài tự ngắt trang
\usepackage{needspace} % Hạn chế tiêu đề và bảng bị tách không hợp lý giữa hai trang
...
% \usepackage{tocbasic} % conflicts with titletoc
