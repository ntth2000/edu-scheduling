...
Mục tiêu tổng quát của đề tài là xây dựng một hệ thống web hỗ trợ lập thời khóa biểu cho trường tiểu học, đáp ứng các yêu cầu nghiệp vụ liên quan tới việc sắp xếp thời khoá biểu và nhu cầu tra cứu thời khóa biểu.
...
\begin{itemize}
    ...
    Xây dựng hệ thống web có giao diện trực quan, thuận tiện cho quá trình sử dụng; triển khai cơ chế xác thực và phân quyền truy cập nhằm bảo vệ các chức năng quản lý; đồng thời xây dựng các kịch bản kiểm thử cho những nghiệp vụ chính của hệ thống.
\end{itemize}
...
Hệ thống phục vụ hai nhóm người dùng gồm người phụ trách lập thời khóa biểu và người dùng vãng lai. Người phụ trách có quyền quản lý thông tin và thực hiện các nghiệp vụ liên quan đến lập thời khóa biểu. Người dùng vãng lai chỉ có quyền tra cứu thời khóa biểu đã được công bố và không được phép thay đổi dữ liệu của hệ thống.

Trong phạm vi xếp lịch, hệ thống được xây dựng theo hướng hỗ trợ người dùng kết
hợp giữa sắp xếp thủ công và sắp xếp tự động. Người dùng giữ vai trò chính trong
việc xây dựng, kiểm tra và hoàn thiện thời khóa biểu; chức năng tự động chỉ đóng
vai trò hỗ trợ phân bổ các tiết học còn thiếu dựa trên những ràng buộc đã được mô
hình hóa trong hệ thống. Các tiết đã được sắp xếp trước được giữ cố định trong
quá trình xử lý. Kết quả do bộ xếp lịch tạo ra được xem là phương án hỗ trợ và
cần được người phụ trách kiểm tra, điều chỉnh và xác nhận trước khi lưu chính
thức.

Do giới hạn về thời gian thực hiện, tài nguyên phần cứng và dữ liệu thử nghiệm,
đề tài mới tập trung xử lý các ràng buộc cốt lõi của bài toán xếp thời khóa biểu
trường tiểu học, chưa bao quát toàn bộ các yêu cầu đặc thù và kinh nghiệm tổ
chức giảng dạy của từng trường.
...
\begin{itemize}
    ...
    Sử dụng Timefold Solver để hỗ trợ phân bổ các tiết học còn thiếu vào những vị trí trống theo các ràng buộc về giáo viên, lớp học và phòng chức năng. Các tiết đã được người dùng sắp xếp trước được giữ cố định trong quá trình xếp tự động. Kết quả được hiển thị để người phụ trách kiểm tra, điều chỉnh và xác nhận trước khi lưu.
\end{itemize}
...
Chương 2 trình bày quá trình khảo sát và phân tích yêu cầu hệ thống. Dựa trên thực trạng xếp thời khóa biểu tại các trường tiểu học công lập, chương này xác định các tác nhân, phân tích các ca sử dụng và đặc tả chi tiết các chức năng cốt lõi của hệ thống, đồng thời làm rõ các yêu cầu phi chức năng cần đáp ứng.

Chương 3 giới thiệu các công nghệ được sử dụng để xây dựng hệ thống, bao gồm Next.js và React phía frontend, Spring Boot và Spring Security phía backend, PostgreSQL làm hệ quản trị cơ sở dữ liệu quan hệ, Timefold Solver hỗ trợ giải bài toán tối ưu thời khóa biểu, cùng các thư viện hỗ trợ xác thực và xuất dữ liệu. Chương này phân tích lý do lựa chọn từng công nghệ trong bối cảnh yêu cầu của đề tài.
...
Chương 5 trình bày kết luận chung của đồ án, tổng hợp các giải pháp và đóng góp nổi bật, đồng thời phân tích những nội dung đã hoàn thành, các hạn chế còn tồn tại và bài học kinh nghiệm trong quá trình thực hiện. Trên cơ sở đó, chương đề xuất các hướng phát triển nhằm hoàn thiện sản phẩm, mở rộng phạm vi ứng dụng và nâng cao chất lượng của chức năng xếp thời khóa biểu.
