// UC01-04 — Bỏ trống tên đăng nhập [Abnormal]
// Steps: để trống username, nhập mật khẩu, nhấn Đăng nhập -> Expect: thông
...
run(async (page) => {
  ...
  assert(!requestSent, "expected no request to /api/auth/login when username is empty");
